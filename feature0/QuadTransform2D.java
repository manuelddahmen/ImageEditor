...
public class QuadTransform2D {
    private one.empty3.libs.Color i1, i2;
    private Point3D[] p1;
    private Point3D[] p2;
    ...
    public QuadTransform2D(Image i1, one.empty3.libs.Color i2, Point3D[] p1, Point3D[] p2) {
        this.i1 = i1;
        this.i2 = i2;
        this.p1 = p1;
        this.p2 = p2;
    ...
    public Inter inter(double p1243, double p1423, double t) {
        ...
        android.graphics.Color color = new Color((float) (double) (cAt.get(0)),
