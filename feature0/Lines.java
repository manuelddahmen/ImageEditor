...
<<<<<<<< HEAD:feature0/Lines.java
package one.empty3.feature;
========
package one.empty3.androidFeature;
>>>>>>>> origin/newBranch3:app/src/main/java/one/empty3/androidFeature/Lines.java
...
<<<<<<<< HEAD:feature0/Lines.java
            ...
            for (List<Point3D> list : lists) {
                android.graphics.Color r = new Color((float) r(), (float) r(), (float) r());
            ...
            one.empty3.ImageIO.write(o.normalize(0.0, 1.0).getImage().getBitmap(), "jpg", out, shouldOverwrite);
            return true;
        } catch (IOException e) {
            e.printStackTrace();
            return false;
...
>>>>>>>> origin/newBranch3:app/src/main/java/one/empty3/androidFeature/Lines.java
        ...
        ImageIO.write(o.normalize(0.0, 1.0).getImage().getBitmap(), "jpg", out, shouldOverwrite);
        return true;
    }
