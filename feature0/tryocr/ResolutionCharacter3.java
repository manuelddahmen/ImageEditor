...
//    PixM outRecompose;
//    private one.empty3.libs.Color read;
//    private String name;
...
//
//        try {
//            one.empty3.ImageIO.write(input.getImage().getBitmap(), "jpg",
//                    new File(dirOut + File.separator + name.replace(' ', '_').replace(".jpg", "INPUT.jpg")));
//            one.empty3.ImageIO.write(output.getImage().getBitmap(), "jpg",
//                    new File(dirOut + File.separator + name.replace(' ', '_').replace(".jpg", "OUTPUT.jpg")));
//
//            one.empty3.ImageIO.write(outRecompose.getImage().getBitmap(), "jpg", new File(
...
//                                try {
//                                    one.empty3.ImageIO.write(outChar.getImage().getBitmap(), "jpg", file);
//                                } catch (IOException e) {
//                                    throw new RuntimeException(e);
//                                }
//                            }
