...
//            });
            ...
            one.empty3.ImageIO.write(o.normalize(0.0, 1.0).getImage().getBitmap(), "jpg", new File(out.getAbsolutePath() + "-dotted.jpg"), shouldOverwrite);
...
//                    new File(out.getAbsolutePath() + "-lines-yAxB.jpg"));
            one.empty3.ImageIO.write(img3.normalize(0.0, 1.0).getImage().getBitmap(), "jpg",
