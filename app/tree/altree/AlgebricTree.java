...
public class AlgebraicTree extends Tree {
    ...
    private one.empty3.library1.tree.TreeNode root;
     ...
     * @param src
     */
    private void checkForSignTreeNode(one.empty3.library1.tree.TreeNode src) {
        ...
        if (src.getChildren().size() >= 2 && src.getChildren().get(1).type.getClass()
            ...
            one.empty3.library1.tree.TreeNode sign = src.getChildren().remove(1);
            one.empty3.library1.tree.TreeNode son0 = src.getChildren().remove(0);
            double sign1 = ((SignTreeNodeType) sign.type).getSign();
            src.getChildren().add(new one.empty3.library1.tree.TreeNode(src, new Object[]{"" + sign1},
                    new SignTreeNodeType(sign1)));
            one.empty3.library1.tree.TreeNode son1 = src.getChildren().get(0);
            son1.getChildren().add(son0);
        }
    }

    public boolean add(one.empty3.library1.tree.TreeNode src, String subformula) throws AlgebraicFormulaSyntaxException {
    ...
    private boolean addFormulaSeparator(one.empty3.library1.tree.TreeNode src, String subformula) {
        String[] s;
        s = subformula.split("=");
        if (s.length > 1) {
    ...
    private boolean addVariable(one.empty3.library1.tree.TreeNode src, String subformula)
    ...
    private boolean addDouble(one.empty3.library1.tree.TreeNode src, String subformula) {
        try {
    ...
    private boolean addSingleSign(one.empty3.library1.tree.TreeNode src, String subformula) throws AlgebraicFormulaSyntaxException {
        if (subformula.length() > 1 && subformula.charAt(0) == '-') {

            if (add(src, subformula.substring(1))) {
                src.getChildren().add(new one.empty3.library1.tree.TreeNode(src, new Object[]{subformula.substring(1)}, new SignTreeNodeType(-1.0)));
                return true;
            }
        }
        return false;
    ...
    public boolean addPower(one.empty3.library1.tree.TreeNode t, String values) throws AlgebraicFormulaSyntaxException {
        int countTerms = 0;

        one.empty3.library1.tree.TreeNode t2;
        int i = 0;
        ...
        while (i < values.length()) {
            ...
            if (isNewExp && count == 0) {
                ...
                if (subsubstring.length() > 0) {
                    t2 = new one.empty3.library1.tree.TreeNode(t, new Object[]{subsubstring}, new PowerTreeNodeType(oldExpSign));
                    if (subsubstring.charAt(0) == '-') {
                        ...
                        t2 = new one.empty3.library1.tree.TreeNode(t2, new Object[]{subsubstring}, signTreeNodeType);
                    }
...
//gen44md78
    ...
    public boolean addFactors(one.empty3.library1.tree.TreeNode t, String values) throws AlgebraicFormulaSyntaxException {
        int countTerms = 0;
        ...
        while (i < values.length()) {
            ...
            if (isNewFactor && count == 0) {
                ...
                if (subsubstring.length() > 0) {
                    t2 = new one.empty3.library1.tree.TreeNode(t, new Object[]{subsubstring}, new FactorTreeNodeType(oldFactorSign));
                    if (subsubstring.charAt(0) == '-') {
                        subsubstring = subsubstring.substring(1);
                        SignTreeNodeType signTreeNodeType = new SignTreeNodeType(-1.0);
                        signTreeNodeType.instantiate(new Object[]{subsubstring});
    ...
    public boolean addTerms(one.empty3.library1.tree.TreeNode t, String values) throws AlgebraicFormulaSyntaxException {
        int countTerms = 0;
        ...
        while (i < values.length()) {
            ...
            if (isNewFactor && count == 0) {
                ...
                if (subsubstring.length() > 0) {
                    t2 = new one.empty3.library1.tree.TreeNode(t, new Object[]{subsubstring}, new TermTreeNodeType(oldFactorSign));
                    if (!add(t2, subsubstring)) {
                        return false;
                    } else {
                        t.getChildren().add(t2);
    ...
    public boolean addFunction(one.empty3.library1.tree.TreeNode t, String values) throws AlgebraicFormulaSyntaxException {
        try {
            int i = 1;
            int count = 0;
            int argumentStart = 0;
            ...
            if (count == 0 && values.charAt(i - 1) == ')') {
                ...
                one.empty3.library1.tree.TreeNode t2 = new TreeTreeNode(t, new Object[]{fParamString, parametersValues, fName},
    ...
    public boolean addMethodCall(one.empty3.library1.tree.TreeNode t, String values) throws AlgebraicFormulaSyntaxException {
        int i = 1;
        boolean isNewFactor = false;
        int count = 0;
        int newFactorPos = 0;
        ...
        while (i < values.length()) {
            ...
            if (count == 0 && values.charAt(i) == ')') {
                ...
                one.empty3.library1.tree.TreeNode t2 = new TreeTreeNode(t, new Object[]{fName, parametersValues, fParamString},
                        mathFunctionTreeNodeType);
                if (!add(t2, fParamString))
                    return false;
                t.getChildren().add(t2);
    ...
    public boolean addBracedExpression(one.empty3.library1.tree.TreeNode t, String values) throws AlgebraicFormulaSyntaxException {
        one.empty3.library1.tree.TreeNode tBraced;
        int i = 0;
        int count = 0;
        while (i < values.length()) {
            if (values.charAt(i) == ')') {
