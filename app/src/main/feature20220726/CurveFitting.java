...
public class CurveFitting extends ProcessFile {
    ...
    */
    ...
    public boolean process(File in, File out) {
        ...
        one.empty3.feature.matrix.PixM p = new one.empty3.feature.PixM(pix.getColumns(), pix.getLines());
...
//                    square, square, 0, 360);
        ...
        new Image(1,1,4).saveToFile(image, "jpg", new File(absolutePath + ".jpg"));
        new Image(1,1,4).saveToFile(outPix.normalize(0.0, 1.0, 0., 1.).getImage(), "jpg", new File(
                absolutePath + "-outPixels.jpg"));
        new Image(1,1,4).saveToFile(inPix.normalize(0.0, 1.0, 0., 1.).getImage(), "jpg", new File(
