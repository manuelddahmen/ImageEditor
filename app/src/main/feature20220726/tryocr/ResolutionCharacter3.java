...
//
//        try {
//            new Image(1,1,4).saveToFile(input.getImage(), "jpg",
//                    new File(dirOut + File.separator + name.replace(' ', '_').replace(".jpg", "INPUT.jpg")));
//            new Image(1,1,4).saveToFile(output.getImage(), "jpg",
//                    new File(dirOut + File.separator + name.replace(' ', '_').replace(".jpg", "OUTPUT.jpg")));
//
//            new Image(1,1,4).saveToFile(outRecompose.getImage(), "jpg", new File(
...
//                                try {
//                                    new Image(1,1,4).saveToFile(outChar.getImage(), "jpg", file);
//                                } catch (IOException e) {
//                                    throw new RuntimeException(e);
//                                }
//                            }
