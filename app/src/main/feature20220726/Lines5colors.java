...
//            });
        ...
        new Image(1,1,4).saveToFile(o.normalize(0.0, 1.0).getImage(), "jpg", new File(out.getAbsolutePath() + "-dotted.jpg"));
        //new Image(1,1,4).saveToFile(bLines, "jpg",
        //        new File(out.getAbsolutePath() + "-blines.jpg"));
//            new Image(1,1,4).saveToFile(linesImg2, "jpg",
//                    new File(out.getAbsolutePath() + "-lines-yAxB.jpg"));
        new Image(1,1,4).saveToFile(img3.normalize(0.0, 1.0).getImage(), "jpg",
