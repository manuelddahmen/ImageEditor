 ...
 */
    ...
    public boolean process(File in, File out) {
        ...
        try {
            ...
            //new Image(1,1,4).saveToFile(pi.getImage(), "JPEG", out);
            new Image(1,1,4).saveToFile(moutA.normalize(0., 1.).getImage(), "JPEG", new File(out.getParent() + "a" + "jpg"));
            new Image(1,1,4).saveToFile(moutB.normalize(0., 1.).getImage(), "JPEG", new File(out.getParent() + "b" + "jpg"));

            //new Image(1,1,4).saveToFile(m2g, "JPEG", new File(out.getParent()+5+"jpg"));
            return true;
        } catch (Exception ex) {
            ex.printStackTrace();
            return false;
