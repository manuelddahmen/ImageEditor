...
public class DiffEnergy extends ProcessFile {
    ...
    public void setPixMS(int img1, int img2) {
        i1 = PixM.getPixM(Objects.requireNonNull(Objects.requireNonNull(ImageIO.read(getStackItem(img1))).bitmap), maxRes);
        i2 = PixM.getPixM(Objects.requireNonNull(Objects.requireNonNull(ImageIO.read(getStackItem(img2))).bitmap), maxRes);
