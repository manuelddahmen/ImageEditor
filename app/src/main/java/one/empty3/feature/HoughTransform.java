...
public class HoughTransform extends ProcessFile {
    ...
    public boolean process(File in, File out) {
        ...
        try {
            ...
            // get the lines out
            Vector<one.empty3.feature.HoughLine> lines = getLines(NUM_LINES);
     ...
     */
    public Vector<one.empty3.feature.HoughLine> getLines(int threshold) {

        // Initialise the vector of lines that we'll return 
        Vector<one.empty3.feature.HoughLine> lines = new Vector<one.empty3.feature.HoughLine>(20);
