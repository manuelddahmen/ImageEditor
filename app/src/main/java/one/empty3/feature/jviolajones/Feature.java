...
public class Feature {
    ...
    one.empty3.feature.jviolajones.Rect[] rects;
    int nb_rects;
    float threshold;
    float left_val;
    float right_val;
    ...
    public Feature(float threshold, float left_val, int left_node, boolean has_left_val,
        ...
        nb_rects = 0;
        rects = new one.empty3.feature.jviolajones.Rect[3];
    ...
    public int getLeftOrRight(int[][] grayImage, int[][] squares, int i, int j, float scale) {
        ...
        for (int k = 0; k < nb_rects; k++) {
            one.empty3.feature.jviolajones.Rect r = rects[k];
        ...
        return (rect_sum2 < threshold * vnorm) ? one.empty3.feature.jviolajones.Tree.LEFT : Tree.RIGHT;
