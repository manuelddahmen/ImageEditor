...
import one.empty3.feature.jviolajones.Stage;
...
public class Detector {
     ...
     */
    List<one.empty3.feature.jviolajones.Stage> stages;
    Point size;
    ...
    public Detector(InputStream input) {
        ...
        Element racine;
        stages = new LinkedList<one.empty3.feature.jviolajones.Stage>();
        ...
        while (it.hasNext()) {
            ...
            one.empty3.feature.jviolajones.Stage st = new one.empty3.feature.jviolajones.Stage(thres);
            while (it2.hasNext()) {
                Element tree = ((Element) it2.next());
                one.empty3.feature.jviolajones.Tree t = new Tree();
                ...
                while (it4.hasNext()) {
                    ...
                    one.empty3.feature.jviolajones.Feature f = new Feature(thres2, left_val, left_node, has_left_val, right_val, right_node, has_right_val, size);
                    Iterator it3 = feature.getChild("feature").getChild("rects").getChildren("_").iterator();
                    while (it3.hasNext()) {
                        String s = ((Element) it3.next()).getText().trim();
                        //System.out.println(s);
                        one.empty3.feature.jviolajones.Rect r = Rect.fromString(s);
                        f.add(r);
                    }
